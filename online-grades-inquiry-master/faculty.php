...
<div class="container">
  ...
  <div class="sixteen columns">
    <div class="h-border">
      <div class="heading">
        <h1 style="color: #062a96;">Faculty Log - In</h1>
      </div>
      <!--Close "Heading" Div-->
    </div>
    <!--Close H-border Div-->
  ...
  <section class="row contact">
    <div class="sixteen columns">
      <form class="clearfix" action="loginscript.php" method="get">
        <table border="1">
        <tr>
        <td><input type="text" class="small-text" placeholder="Employee Number" name="un" required></td>
        <td><input type="password" class="small-text" placeholder="Password" name="pw" required></td>
        </tr>
        <tr>
        <td colspan="2" > <input type="Submit" value="Go" class="btn green"></td>
        </tr>
        </table>
